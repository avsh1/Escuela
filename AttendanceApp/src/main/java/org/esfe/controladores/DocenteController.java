...
@Autowired
    private IDocentesService docentesService;
    ...
    public String index(Model model, @RequestParam("page") Optional<Integer> page, @RequestParam("size") Optional<Integer> size){
        ...
        Page<Docente> docentes = docentesService.buscarTodosPaginados(pageable);
    ...
    public String save(Docente docente, BindingResult result, Model model, RedirectAttributes attributes){
        ...
        docentesService.crearOEditar(docente);
    ...
    public String details(@PathVariable("id") Integer id, Model model){
        Docente docente = docentesService.buscarPorId(id).get();
    ...
    public String delete(Docente docente, RedirectAttributes attributes){
        docentesService.eliminarPorId(docente.getId());
